...
public class ExeJsViewResolver implements ViewResolver, Ordered {
	...
	/**
	 * Dado un nombre lógico de la vista, comprobaos si existe una plantilla que
	 * lo corresponda En caso de que exista, se devuelve el objeto que se
	 * encargará de generar la vista, llamado View En caso de que no exista, se
	 * devuelve null y Spring probará con otro ViewResolver (el siguiente en
	 * prioridad)
	 */
	@Override
