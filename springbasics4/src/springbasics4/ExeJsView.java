...
public class ExeJsView extends AbstractView {
	  ...
	  protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception 
	  {
		    ...
		    //pero podr�a coger otro fichero de cualquier sitio
		    //preferiblemente se supone que las plantillas mejor dentro de WEB-INF (y no en la ra�z WebContent), para que el propio
		    //mecanismo de seguridad con que cuenta el contenedor JEE, impida el acceso p�blico al fichero jsp
		    Resource template = new ClassPathResource(EXE_JS_TEMPLATE_NAME);
		    
		    //tomo la subplantilla, preguntando primero si ya est� cargada para ahorr�rmela
